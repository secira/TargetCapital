    ...
    def get_subscription_plans(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            ...
            'TRADER': {
                ...
                'price': 1499,
                'duration_days': 30,
                'features': ['Advanced charts', 'Real-time data', 'Trading signals', 'Basic AI advisor'],
                'limits': {'portfolios': 3, 'watchlist': 50, 'ai_queries': 100}
            },
            'TRADER_PLUS': {
                'name': 'Trader Plus Plan',
                'price': 2999,
                'duration_days': 30,
                'features': ['All Trader features', 'Broker integration', 'Advanced AI insights', 'Portfolio optimization'],
                'limits': {'portfolios': 10, 'watchlist': 200, 'ai_queries': 500}
            },
            'PREMIUM': {
                'name': 'Premium Plan',
                'price': 4999,
